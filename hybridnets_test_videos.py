...
parser.add_argument('--conf_thresh', type=restricted_float, default='0.35')
parser.add_argument('--iou_thresh', type=restricted_float, default='0.4')
...
color_list_seg = {'road': [181, 255, 82], "lane": [251, 216, 44]}
color_list_seg = {'road': [43, 255, 153], "lane": [255, 7, 205]}
# color_list_seg = {}
...
video_srcs = glob(f'{source}/*.mp4') # read video filenames
