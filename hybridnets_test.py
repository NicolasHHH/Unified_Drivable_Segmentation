...
color_list_seg = {'road': [144, 180, 75], "lane": [219, 142, 113]}
color_list_seg = {'road': [43, 255, 153], "lane": [255, 7, 205]}
# assign colors to seg elements
...
for ori_img in ori_imgs: # len(test_images)
    h0, w0 = ori_img.shape[:2]  # orig hw
    r = resized_shape / max(h0, w0)  # resize image to img_size
    # resized_shape : (int(w0 * r), int(h0 * r))
...
with torch.no_grad():
    ...
    # classification : torch.Size([6, 46035, 2]) # 11*31*27*5
